...
VALUES 
('66666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111', 'e198f49f-0887-4566-9d65-c269fb1e264f', 100, 0, 10);

INSERT INTO inventory_items (product_variant_id, warehouse_id, vendor_id, quantity_available, quantity_reserved, safety_stock)
VALUES 
('77777777-7777-7777-7777-777777777777', '22222222-2222-2222-2222-222222222222', 'e198f49f-0887-4566-9d65-c269fb1e264f', 50, 0, 5);

INSERT INTO stock_movements (id, product_variant_id, warehouse_id, vendor_id, type, quantity, reference_type, notes, created_by)
VALUES 
(uuid_generate_v4(), '66666666-6666-6666-6666-666666666666', '11111111-1111-1111-1111-111111111111', 'e198f49f-0887-4566-9d65-c269fb1e264f',
 'INBOUND', 100, 'IMPORT', 'Nhập hàng áo thun đen size M', 'system');

INSERT INTO stock_movements (id, product_variant_id, warehouse_id, vendor_id, type, quantity, reference_type, notes, created_by)
VALUES 
(uuid_generate_v4(), '77777777-7777-7777-7777-777777777777', '22222222-2222-2222-2222-222222222222', 'e198f49f-0887-4566-9d65-c269fb1e264f',
